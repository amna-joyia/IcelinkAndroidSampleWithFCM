 ...
 * Signalling
 *
 * Provides abstract methods doJoinAsync and doLeaveAsync.
...
public abstract class Signalling {
    ...
    /**
     * Calls to the abstract doLeaveAsync method, chaining disconnection
     * of the WebSync client to the returned Future. Disconnection includes
     * DisconnectArgs which set the OnComplete callback.
     *
     * @return Future
     */
    public Future<Object> leaveAsync() {
        return doLeaveAsync().then(new IAction1<Object>() {
            @Override
            public void invoke(Object object) {
                unsubscribeFromChannel(metadataChannel);
            }
        }).then(new IFunction1<Object, Future<Object>>() {
            @Override
            public Future<Object> invoke(Object o) {
                final Promise<Object> promise = new Promise<Object>();
                try {
